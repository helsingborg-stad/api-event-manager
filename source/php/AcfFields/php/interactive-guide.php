<?php 
    ...
    'fields' => array(
        ...
        1 => array(
            'key' => 'field_5f6daf6ec85cc',
            'label' => __('Message delay', 'event-manager'),
            'name' => 'custom_message_delay',
            'type' => 'radio',
            'instructions' => __('Use default or custom message delay for this guide.', 'event-manager'),
            'required' => 0,
            'conditional_logic' => 0,
            'wrapper' => array(
                'width' => '',
        ...
        2 => array(
            'key' => 'field_5f6dafb4c85cd',
            'label' => __('Delay', 'event-manager'),
            'name' => 'message_delay',
            'type' => 'number',
            'instructions' => __('Enter value in milliseconds.', 'event-manager'),
            'required' => 1,
                ...
                'layout_5f68bc561a427' => array(
                    ...
                    'sub_fields' => array(
                        ...
                        1 => array(
                            ...
                            'name' => 'content',
                            'type' => 'text',
                            'instructions' => __('Content to be displayed on start screen.', 'event-manager'),
                            'required' => 0,
                            'conditional_logic' => 0,
                            'wrapper' => array(
                                'width' => '',
