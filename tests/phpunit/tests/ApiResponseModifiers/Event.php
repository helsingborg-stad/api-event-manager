...
{
    /**
     * @testdox response is only modified in the view context.
     */
    public function testResponseOnlyModifiedInViewContext()
    {
        ...
        $mockRequest->shouldReceive('get_param')->with('context')->andReturn('edit');
    ...
    /**
     * @testdox response is modified in the view context.
     */
    public function testResponseModifiedInViewContext()
    {
        ...
        $eventModifier = new \EventManager\ApiResponseModifiers\Event($mockPostToSchema);
        $result        = $eventModifier->modify($mockResponse, $mockPost, $mockRequest);
